...
ifeq ($(findstring VOLUME_RENDERING, $(OPTION)), VOLUME_RENDERING)
    SRC_CPP_BASE += VolumeRendering/tau_sph.cpp
endif
...
#    VTK_ROOT = /opt/homebrew/opt/vtk
    ...
    INCL += -I$(SRC_DIR)/IsoSurface -I$(SRC_DIR)/OctTree
    SRC_CPP_BASE += IsoSurface/marching_cubes.cpp IsoSurface/connectivity_test.cpp IsoSurface/density_evaluate.cpp IsoSurface/IsoSurfaceGenerator.cpp
    SRC_CPP_BASE += OctTree/ParticleOctree.cpp
